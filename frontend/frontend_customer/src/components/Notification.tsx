...
import '../styles/checkout.css'; // Use checkout.css for now, or create Notification.css if needed
...
const Notification: React.FC<NotificationProps> = ({
  ...
  return (
    <div className={`notification notification-${type}`} style={{ position: 'fixed', top: 20, right: 20, zIndex: 9999 }}>
